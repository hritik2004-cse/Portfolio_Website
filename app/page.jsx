  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col xl:flex-row items-start md:items-center justify-between w-full">
        <div className="w-full xl:w-[550px] flex flex-col items-start md:items-center xl:items-start text-left md:text-center xl:text-left">
          ...
          <p className="max-w-[320px] sm:max-w-[420px] xl:max-w-[500px] mb-4 md:mb-7 text-white/70 text-sm md:text-base lg:text-lg">
          ...
          <div className="flex flex-col xl:flex-row xl:items-center gap-3 xl:gap-8 mb-12 xl:mb-0">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <Link href="mailto:hritiksharma08725@gmail.com">
                <p className="text-sm md:text-base text-white/70">
